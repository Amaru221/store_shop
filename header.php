<header>
    <nav id ="navegador" class = "nav">
        ...
        <a id="carrito" class="nav-link" href="#" onclick="verPestania(event, 'active' );">Mi Cesta <span id="contador_carrito" class = "contador_carrito"><?php echo count($_SESSION['carrito'])?></span></a>
        <a class="nav-link" href="logout.php">Usuario: <?= $_SESSION['usuario'] ?> Cerrar sesión</a>
